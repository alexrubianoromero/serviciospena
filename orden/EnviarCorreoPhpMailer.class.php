...
class EnviarCorreoPhpMailer 
{
    ...
    public function enviarCorreoPhpMailer(){
        ...
        try {
            ...
            $this->mail->Username   = 'prueba@arsolutiontechnology.com';                     //SMTP username
            $this->mail->Password   = 'Prueba2468*';                               //SMTP password
            $this->mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
            $this->mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
            //Recipients
            $this->mail->setFrom('prueba@arsolutiontechnology.com', 'KAYMO Software para Talleres');
