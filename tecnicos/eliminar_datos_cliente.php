...
$sql_revisar_ciente = "select  cli.identi,cli.nombre,c.placa  from tecnicos as cli 
...
// if($filas_revision < 1)
// {
$sql_eliminar_cliente = "delete from tecnicos where idcliente = '".$_REQUEST['idcliente']."'  ";
